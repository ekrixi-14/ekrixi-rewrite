using Content.Server._Ekrixi.Splatter;
...
public sealed class BloodstreamSystem : EntitySystem
{
    ...
    // begin ekrixi edit
    [Dependency] private readonly SplatterSystem _splatterSystem = default!;
    // end ekrixi edit
    ...
    private void OnDamageChanged(Entity<BloodstreamComponent> ent, ref DamageChangedEvent args)
    {
        ...
        // begin ekrixi edit
        if (totalFloat > 1f)
            _splatterSystem.SplatAt(ent, _splatterSystem.RandomDirection() * totalFloat);
        // end ekrixi edit
